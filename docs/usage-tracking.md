...
The database is not encrypted. The plugin creates and reopens it with `0600` file permissions; protect its directory with filesystem permissions and volume access controls as well.
